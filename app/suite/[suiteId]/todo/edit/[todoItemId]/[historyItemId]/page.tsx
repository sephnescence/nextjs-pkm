...
export default function TodoEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(`/api/suite/${suiteId}/todo/${todoItemId}/${historyItemId}`, {
        method: 'GET',
      }),
    )
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/todo/view/${todoItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/todo/${todoItemId}/${historyItemId}`}
        apiMethod="PATCH"
