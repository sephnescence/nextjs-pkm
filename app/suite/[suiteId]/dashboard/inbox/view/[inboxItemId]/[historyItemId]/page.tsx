...
export default async function InboxViewRoute({
  ...
  const inboxInboxHistoryItem = await getCurrentInboxItemForUser({
    suiteId,
    storeyId: null, // Suite Inbox items won't have a storeyId
    spaceId: null, // Suite Inbox items won't have a spaceId
    inboxItemId,
    historyItemId,
    userId: user.id,
  })
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/dashboard/inbox/edit/${inboxItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link href={`/suite/${suiteId}/dashboard?tab=inbox`}>
          <button
