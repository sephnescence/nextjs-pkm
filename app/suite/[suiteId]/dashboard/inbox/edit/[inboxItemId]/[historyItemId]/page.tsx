...
export default function InboxEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/dashboard/inbox/${inboxItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, inboxItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/dashboard/inbox/view/${inboxItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/dashboard/inbox/${inboxItemId}/${historyItemId}`}
        apiMethod="PATCH"
