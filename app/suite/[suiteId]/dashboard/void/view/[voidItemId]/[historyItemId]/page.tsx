...
export default async function VoidViewRoute({
  ...
  const voidVoidHistoryItem = await getCurrentVoidItemForUser({
    suiteId,
    storeyId: null, // Suite Void items won't have a storeyId
    spaceId: null, // Suite Void items won't have a spaceId
    voidItemId,
    historyItemId,
    userId: user.id,
  })
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/dashboard/void/edit/${voidItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link href={`/suite/${suiteId}/dashboard?tab=void`}>
          <button
