...
export default function VoidEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/dashboard/void/${voidItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/dashboard/void/view/${voidItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/dashboard/void/${voidItemId}/${historyItemId}`}
        apiMethod="PATCH"
