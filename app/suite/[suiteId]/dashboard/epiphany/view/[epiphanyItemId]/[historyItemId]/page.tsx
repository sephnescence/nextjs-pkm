...
export default async function EpiphanyViewRoute({
  ...
  const epiphanyEpiphanyHistoryItem = await getCurrentEpiphanyItemForUser({
    suiteId,
    storeyId: null, // Suite Epiphany items won't have a storeyId
    spaceId: null, // Suite Epiphany items won't have a spaceId
    epiphanyItemId,
    historyItemId,
    userId: user.id,
  })
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/dashboard/epiphany/edit/${epiphanyItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link href={`/suite/${suiteId}/dashboard?tab=epiphany`}>
          <button
