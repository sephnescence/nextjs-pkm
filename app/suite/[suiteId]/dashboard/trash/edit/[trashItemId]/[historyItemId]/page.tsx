...
export default function TrashEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/dashboard/trash/${trashItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, trashItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/dashboard/trash/view/${trashItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/dashboard/trash/${trashItemId}/${historyItemId}`}
        apiMethod="PATCH"
