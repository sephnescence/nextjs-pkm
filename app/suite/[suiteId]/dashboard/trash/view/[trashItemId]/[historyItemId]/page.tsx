...
export default async function TrashViewRoute({
  ...
  const trashTrashHistoryItem = await getCurrentTrashItemForUser({
    suiteId,
    storeyId: null, // Suite Trash items won't have a storeyId
    spaceId: null, // Suite Trash items won't have a spaceId
    trashItemId,
    historyItemId,
    userId: user.id,
  })
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/dashboard/trash/edit/${trashItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link href={`/suite/${suiteId}/dashboard?tab=trash`}>
          <button
