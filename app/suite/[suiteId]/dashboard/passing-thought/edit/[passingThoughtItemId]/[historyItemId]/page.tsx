...
export default function PassingThoughtEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/dashboard/passing-thought/${passingThoughtItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, passingThoughtItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/dashboard/passing-thought/view/${passingThoughtItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/dashboard/passing-thought/${passingThoughtItemId}/${historyItemId}`}
        apiMethod="PATCH"
