...
export default function TrashEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/trash/${trashItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/trash/view/${trashItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/trash/${trashItemId}/${historyItemId}`}
        apiMethod="PATCH"
