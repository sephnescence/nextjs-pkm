...
export default function EpiphanyEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/epiphany/${epiphanyItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/epiphany/view/${epiphanyItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/epiphany/${epiphanyItemId}/${historyItemId}`}
        apiMethod="PATCH"
