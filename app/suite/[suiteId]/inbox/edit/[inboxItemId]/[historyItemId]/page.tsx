...
export default function InboxEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/inbox/${inboxItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/inbox/view/${inboxItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/inbox/${inboxItemId}/${historyItemId}`}
        apiMethod="PATCH"
