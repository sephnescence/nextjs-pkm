                ...
                <div className="absolute top-0 left-0 flex">
                  <div className="bg-indigo-950 h-8 mr-2 py-1 px-3 rounded-lg hover:bg-violet-900">
                    <Link
                      ...
                      href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/create`}
                    >
                      <LightbulbIcon />
                ...
                .map((item) => {
                  return (
                    <div key={item.model_id}>
                      <Link
                        href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/view/${item.model_id}/${item.history_id}`}
                      >
              ...
              <div className="relative">
                <div className="absolute top-0 left-0 flex">
                  <div className="bg-indigo-950 h-8 mr-2 py-1 px-3 rounded-lg hover:bg-violet-900">
                    <Link
                      className="flex rounded-lg focus:outline-offset-1 focus:outline-lime-600"
                      href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/inbox/create`}
                    >
                      <InboxStackIcon />
                      <PlusIcon viewBox="6 -3 12 48" className="w-2 h-6" />
                    </Link>
              ...
              {space?.pkm_history
                ...
                .map((item) => {
                  return (
                    <div key={item.model_id}>
                      <Link
                        href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/inbox/view/${item.model_id}/${item.history_id}`}
                      >
                ...
                <div className="absolute top-0 left-0 flex">
                  <div className="bg-indigo-950 h-8 mr-2 py-1 px-3 rounded-lg hover:bg-violet-900">
                    <Link
                      ...
                      href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/passing-thought/create`}
                    >
                      <BoltIcon />
                      <PlusIcon viewBox="6 -3 12 48" className="w-2 h-6" />
                    </Link>
              ...
              {space?.pkm_history
                ...
                .map((item) => {
                  return (
                    <div key={item.model_id}>
                      <Link
                        href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/passing-thought/view/${item.model_id}/${item.history_id}`}
                      >
                        <PassingThought
                ...
                <div className="absolute top-0 left-0 flex">
                  <div className="bg-indigo-950 h-8 mr-2 py-1 px-3 rounded-lg hover:bg-violet-900">
                    <Link
                      ...
                      href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/todo/create`}
                    >
                      <BellAlertIcon />
                      <PlusIcon viewBox="6 -3 12 48" className="w-2 h-6" />
                    </Link>
              ...
              {space?.pkm_history
                ...
                .map((item) => {
                  return (
                    <div key={item.model_id}>
                      <Link
                        href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/todo/view/${item.model_id}/${item.history_id}`}
                      >
                ...
                <div className="absolute top-0 left-0 flex">
                  <div className="bg-indigo-950 h-8 mr-2 py-1 px-3 rounded-lg hover:bg-violet-900">
                    <Link
                      ...
                      href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/void/create`}
                    >
                      <ArchiveBoxXMarkIcon />
                      <PlusIcon viewBox="6 -3 12 48" className="w-2 h-6" />
                    </Link>
              ...
              {space?.pkm_history
                ...
                .map((item) => {
                  return (
                    <div key={item.model_id}>
                      <Link
                        href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/void/view/${item.model_id}/${item.history_id}`}
                      >
  ...
  return (
    <>
      <p className="text-4xl mb-2">
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/config`}
        >
          {space.name}
        </Link>
      </p>
