  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/passing-thought/edit/${passingThoughtItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard?tab=passing-thought`}
        >
          <button
