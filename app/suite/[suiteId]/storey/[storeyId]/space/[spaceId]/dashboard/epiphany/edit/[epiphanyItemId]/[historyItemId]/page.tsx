...
export default function EpiphanyEditRoute({
  params: { suiteId, storeyId, spaceId, epiphanyItemId, historyItemId },
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/${epiphanyItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, storeyId, spaceId, epiphanyItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/view/${epiphanyItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/${epiphanyItemId}/${historyItemId}`}
        apiMethod="PATCH"
