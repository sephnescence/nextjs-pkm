...
export default async function TrashViewRoute({
  ...
  const trashTrashHistoryItem = await getCurrentTrashItemForUser({
    suiteId: null, // Space Trash items won't actually have a suiteId, but the url will
    storeyId,
    spaceId,
    trashItemId,
    historyItemId,
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/trash/edit/${trashItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard?tab=trash`}
        >
          <button
