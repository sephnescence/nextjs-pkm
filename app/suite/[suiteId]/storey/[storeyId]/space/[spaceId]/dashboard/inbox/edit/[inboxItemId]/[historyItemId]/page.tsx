...
export default function InboxEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/inbox/${inboxItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, storeyId, spaceId, inboxItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/inbox/view/${inboxItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/inbox/${inboxItemId}/${historyItemId}`}
        apiMethod="PATCH"
