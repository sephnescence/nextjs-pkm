...
export default function TrashEditRoute({
  params: { suiteId, storeyId, spaceId, trashItemId, historyItemId },
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/trash/${trashItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
      ...
      .catch(() => {})
  }, [setResJon, suiteId, storeyId, spaceId, trashItemId, historyItemId])
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/trash/view/${trashItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/trash/${trashItemId}/${historyItemId}`}
        apiMethod="PATCH"
