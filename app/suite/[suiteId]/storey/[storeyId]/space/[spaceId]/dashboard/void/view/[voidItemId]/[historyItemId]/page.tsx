...
export default async function VoidViewRoute({
  ...
  const voidVoidHistoryItem = await getCurrentVoidItemForUser({
    suiteId: null, // Space Void items won't actually have a suiteId, but the url will
    storeyId,
    spaceId,
    voidItemId,
    historyItemId,
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/void/edit/${voidItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard?tab=void`}
        >
          <button
