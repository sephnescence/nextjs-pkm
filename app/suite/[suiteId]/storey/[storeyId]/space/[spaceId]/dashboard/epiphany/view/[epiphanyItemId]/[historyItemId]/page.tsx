...
export default async function EpiphanyViewRoute({
  ...
  const epiphanyEpiphanyHistoryItem = await getCurrentEpiphanyItemForUser({
    suiteId: null, // Space Epiphany items won't actually have a suiteId, but the url will
    storeyId,
    spaceId,
    epiphanyItemId,
    historyItemId,
  ...
  return (
    <div className="">
      ...
      <div className="w-full mb-4">
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard/epiphany/edit/${epiphanyItemId}/${historyItemId}`}
        >
          <button
        ...
        <Link
          href={`/suite/${suiteId}/storey/${storeyId}/space/${spaceId}/dashboard?tab=epiphany`}
        >
          <button
