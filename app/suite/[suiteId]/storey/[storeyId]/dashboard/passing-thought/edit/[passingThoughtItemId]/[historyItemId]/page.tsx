...
export default function PassingThoughtEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/dashboard/passing-thought/${passingThoughtItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/dashboard/passing-thought/view/${passingThoughtItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/dashboard/passing-thought/${passingThoughtItemId}/${historyItemId}`}
        apiMethod="PATCH"
