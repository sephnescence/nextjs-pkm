...
export default function TodoEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/dashboard/todo/${todoItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/dashboard/todo/view/${todoItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/dashboard/todo/${todoItemId}/${historyItemId}`}
        apiMethod="PATCH"
