...
export default function TrashEditRoute({
  ...
  useEffect(() => {
    fetch(
      new Request(
        `/api/suite/${suiteId}/storey/${storeyId}/dashboard/trash/${trashItemId}/${historyItemId}`,
        {
          method: 'GET',
        },
      ),
  ...
  return (
    <>
      <ItemForm
        ...
        cancelUrl={`/suite/${suiteId}/storey/${storeyId}/dashboard/trash/view/${trashItemId}/${historyItemId}`}
        apiEndpoint={`/api/suite/${suiteId}/storey/${storeyId}/dashboard/trash/${trashItemId}/${historyItemId}`}
        apiMethod="PATCH"
