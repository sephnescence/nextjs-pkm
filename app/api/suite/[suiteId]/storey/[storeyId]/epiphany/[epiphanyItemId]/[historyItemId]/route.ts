...
export const PATCH = async (
  ...
  return NextResponse.json({
    success: true,
    redirect: `/suite/${existingEpiphany.storey.suite.id}/storey/${storeyId}/epiphany/view/${newEpiphanyItem.epiphanyItem.model_id}/${newEpiphanyItem.epiphanyItem.history_id}`,
  })
}
