...
export const PATCH = async (
  ...
  if (!existingPassingThought || !existingPassingThought.storey) {
    return NextResponse.json({
      success: false,
      error: 'This is an old passingThought item. You cannot edit it.',
    })
  }
  ...
  return NextResponse.json({
    success: true,
    redirect: `/suite/${existingPassingThought.storey.suite.id}/storey/${storeyId}/space/${spaceId}/passingThought/view/${newPassingThoughtItem.passingThoughtItem.model_id}/${newPassingThoughtItem.passingThoughtItem.history_id}`,
  })
}
